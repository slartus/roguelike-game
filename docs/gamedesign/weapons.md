...
| Dagger (legacy) | legacy | `projectile` | ![Игрок с кинжалом](media/player_with_dagger.png) |
| Pistol (legacy) | legacy | `projectile` | ![Игрок с пистолетом](media/player_with_pistol.png) |
| Shotgun (legacy) | legacy | `projectile` | ![Игрок с дробовиком](media/player_with_shotgun.png) |
