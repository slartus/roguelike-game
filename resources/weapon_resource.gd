...
# (тот про снаряд). У всех 9 оружий свои icon_texture, поэтому дефолт WHITE
# рендерит спрайт как есть. Кастомный оттенок — если понадобится redshift-
# эффект / damage-flash / реролл-версия без своего PNG.
