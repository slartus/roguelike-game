...
<img src="../../assets/sprites/enemies/slime.png" width="48" alt="Slime"/>
...
Медленный, слабый, безобидный поодиночке. Опасен тем, что **делится**: при агре запускает таймер, через 4 секунды рядом появляется вторая слизь (максимум одно почкование на слайма). Комнатa с тремя слизнями за минуту превращается в шесть.
...
Тактика: держи дистанцию, отстреливай миньонов на подходе, между залпами вкладывай урон в самого босса.
